...
// 2022-05-02 13:13:26.102908328 +0100 BST m=+0.001371138
...
var localizations = map[string]string{
	"en.devicechooser.bus":                  "Bus {{.busID}}",
	"en.devicechooser.bus-id":               "Bus.Device",
	"en.devicechooser.cancel":               "_Cancel",
	"en.devicechooser.device":               "Device {{.deviceID}}:",
	"en.devicechooser.device-name":          "{{.vendorName}} {{.deviceName}}",
